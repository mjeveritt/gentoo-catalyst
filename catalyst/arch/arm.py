...
class arch_armv4tl(generic_arm):
	...
	def __init__(self,myspec):
		generic_arm.__init__(self,myspec)
		self.settings["CHOST"]="armv4tl-unknown-linux-gnueabi"
...
class arch_armv5tl(generic_arm):
	...
	def __init__(self,myspec):
		generic_arm.__init__(self,myspec)
		self.settings["CHOST"]="armv5tl-unknown-linux-gnueabi"
...
class arch_armv5tel(generic_arm):
	...
	def __init__(self,myspec):
		generic_arm.__init__(self,myspec)
		self.settings["CHOST"]="armv5tel-unknown-linux-gnueabi"
...
class arch_armv5tejl(generic_arm):
	...
	def __init__(self,myspec):
		generic_arm.__init__(self,myspec)
		self.settings["CHOST"]="armv5tejl-unknown-linux-gnueabi"
		self.settings["COMMON_FLAGS"]+=" -march=armv5te"
...
class arch_armv5teb(generic_armeb):
	...
	def __init__(self,myspec):
		...
		self.settings["CHOST"]="armv5teb-unknown-linux-gnueabi"
